    ...
    const getRoleDetails = (role) => {
      ...
      switch (normalizedRole) {
        case 'admin':
          ...
          break;
        case 'manager':
          details = { label: 'Manager', color: '#fd7e14' };
          break;
        case 'customer':
          details = { label: 'Customer', color: '#20c997' };
          break;
        case 'stockManager':
          details = { label: 'Stock Manager', color: '#6f42c1' };
          break;
        case 'customerAssistance':
          details = { label: 'Support', color: '#0dcaf0' };
          break;
        case 'deliveryAgent':
          details = { label: 'Delivery', color: '#4F46E5' };
          break;
        case 'supplier':
