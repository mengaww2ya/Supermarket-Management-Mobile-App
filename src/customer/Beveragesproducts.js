...
export default function BeveragesproductsList({ navigation }) {
  ...
  // Filter only active beverage products
  const activeProducts = Beveragesproducts.filter(
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-100 px-2">
      ...
      <View className="flex-row items-center justify-between bg-yellow-300 px-4 py-3">
        <Text className="text-lg font-bold text-green-600">Beverage Products</Text>
